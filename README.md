...
```gradle
implementation 'com.devrapid.jieyi:kotlinknifer:2.0.3'

implementation 'com.devrapid.jieyi:kotlinshaver:1.0.3'
```
...
```gradle
implementation('com.devrapid.jieyi:kotlinshaverr:1.0.3', {
